            ...
            <div className="Ride-App-Mobi">
                <div className="mobi_app_left">
                    ...
                    <div className="mobi_app_button">
                        <img className="mobi_app_store store1" src="/img/app-store.png" alt></img>
                        <img className="mobi_app_store" src="/img/google-play.png" alt></img>
                    </div>
                </div>
                <div className="mobi_app_right">
                        <picture className="mobi_app_picture">
                            <source media="(max-width: 991px)" srcSet="/img/app-preview-m.png" alt></source>
                            <img className="mobi_app_img" src="/img/app-preview-xl.png" alt></img>
                        </picture>
                </div>
            </div>
        </>
